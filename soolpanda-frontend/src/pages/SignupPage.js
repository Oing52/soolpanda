  ...
  return (
    <div className="register_form_box">
      ...
      <form onSubmit={handleSubmit}>
        <div
          className={`${idMessage ? (isId ? " valid" : " invalid") : ""} id_box${
        ...
        >
          <div className="idBox">
            ...
            />
            {idMessage && (
              <div className={`message${isId ? "_hidden" : "_visible"}`}>6자 이상 16자 이하의 문자로 입력하세요!</div>
            )}
          </div>
          <br />
          <br />
        ...
        <div className={`password_box${passwordMessage ? (isPassword ? " valid" : " invalid") : ""}`}>
          ...
          />
          {passwordMessage && (
            <div className={`message${isPassword ? "_hidden" : "_visible"}`}>
              영어, 숫자, 특수문자를 혼합하여 8자리 이상 입력하세요!
            </div>
          )}
        </div>
        <div className={`passwordConfirm_box${passwordConfirmMessage ? (isPasswordConfirm ? " valid" : " invalid") : ""}`}>
          ...
          {passwordConfirmMessage && (
            <div className={`message${isPasswordConfirm ? "_hidden" : "_visible"}`}>비밀번호가 일치하지 않습니다!</div>
          )}
        </div>
        <div className={`name_box${nameMessage ? (isName ? " valid" : " invalid") : ""}`}>
          ...
          />
          {nameMessage && <div className={`message${isName ? "_hidden" : "_visible"}`}>올바른 이름을 입력하세요!</div>}
        </div>
        ...
        <div
          className={`${emailMessage ? (isEmail ? " valid" : " invalid") : ""} id_box${
